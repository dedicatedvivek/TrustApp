        ...
        <div class="flex-center position-ref full-height" >
            @if (Route::has('login'))
                <div class="top-right links"">
                    @auth
                       <a id="proceedto" href="{{ url('/home') }}" style="color: #19303A"><b>LOGOUT</b></a>
            ...
            <div class="content">
                ...
                <div class="links" >
                    <a class="linkanchor" href="{{ url('/newapplicant') }}"><b>NEW APPLICANT&nbsp&nbsp</b></a>
                    <a class="linkanchor" href="{{ url('/listapplicant') }}">APPLICANTS LIST&nbsp&nbsp</a>
                    <a class="linkanchor" href="{{ url('/bank') }}">BANKS&nbsp&nbsp</a>
                    <a class="linkanchor" href="{{ url('/saving') }}">SAVINGS&nbsp&nbsp</a>
                    <a class="linkanchor" href="{{ url('/transaction') }}">TRANSACTIONS&nbsp&nbsp</a>
